...
const Simulator = () => {
    ...
    const StatCard = ({ title, value, trend, icon: Icon, highlight }) => (
        <div className={`glass-panel hover-glow flex flex-col justify-between ${highlight ? 'iridescent-border glow-pulse' : ''}`} style={{ padding: '1.25rem', height: '140px', background: highlight ? 'rgba(59, 130, 246, 0.05)' : 'linear-gradient(135deg, rgba(255,255,255,0.02) 0%, rgba(255,255,255,0.01) 100%)' }}>
